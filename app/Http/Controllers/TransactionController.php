...
class TransactionController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('transactions.index')->with('status', 'Transaksi berhasil diubah!');
    }
    ...
    public function setStatus(Request $request, $id)
    {
        ...
        return redirect()->route('transactions.index')->with('status', 'Berhasil ubah status transaksi');
    }
}
